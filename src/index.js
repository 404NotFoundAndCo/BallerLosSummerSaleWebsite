...
function toggleLightDarkMode() {
  ...
  document.getElementById("teamImageLeft").src = newMode == 'dark-mode' ? './Images/people-group-solid_inverted.png' : './Images/people-group-solid.svg';
  document.getElementById("teamImageRight").src = newMode == 'dark-mode' ? './Images/people-group-solid_inverted.png' : './Images/people-group-solid.svg';
  document.getElementById("high-contrast").src = newMode == 'dark-mode' ? "./Images/brightness_white.png" : "./Images/brightness_black.png"
